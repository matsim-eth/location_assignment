...
public class SBBStatistics {
    ...
    public SBBStatistics(long numberOfPersons) {
        this(numberOfPersons, null);
    }

    public SBBStatistics(long numberOfPersons, Optional<OutputStream> output) {
        this.numberOfPersons = numberOfPersons;
        this.writer = output.map(OutputStreamWriter::new).map(BufferedWriter::new);

        for (String mode : Arrays.asList("car", "ride", "pt", "bike", "walk")) {
